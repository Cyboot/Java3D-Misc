/*
 *      @(#)TextureCoordApp.java 1.2 01/06/18
 *
...
/**
 * TextureCoordApp creates a single plane with texture mapping.
 */
public class TextureCoordApp extends Applet {
    ...
    BranchGroup createScene() { 
      ...
      texturedQuad.setTextureCoordinate( 0, 0, new TexCoord2f( 1.0f, 1.0f));
      ...
      texturedQuad.setTextureCoordinate( 0, 2, new TexCoord2f( 0.0f, 1.0f));
      ...
      texturedQuad = (QuadArray) texturedPlane.getGeometry();
      texturedQuad.setTextureCoordinate( 0, 0, new TexCoord2f( 0.5f, 0.0f));
      texturedQuad.setTextureCoordinate( 0, 1, new TexCoord2f( 1.0f, 0.5f));
      texturedQuad.setTextureCoordinate( 0, 2, new TexCoord2f( 0.5f, 1.0f));
      texturedQuad.setTextureCoordinate( 0, 3, new TexCoord2f( 0.0f, 0.5f));
  ...
  {
    System.out.println("TextureCoordApp.java");
    ...
    new MainFrame(new TextureCoordApp(), 512, 128);
  }
}
