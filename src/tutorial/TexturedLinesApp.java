/*
 *      @(#)TexturedLinesApp.java v1.2 01/06/21
 *
 ...
 * written in Java 3D
 *
 * TexturedLinesApp.java demonstrates line texturing.
...
public class TexturedLinesApp extends Applet {
    ...
    Geometry createTwistGeometry(){
        ...
        TexCoord2f TC1 = new TexCoord2f(0.0f, 0.0f);
        TexCoord2f TC2 = new TexCoord2f(1.0f, 0.0f);
        ...
        for(v = 0, a=0.0; v < N; v+=2, a=v*2.0*Math.PI/(N-2)){
            ...
            twistStrip.setTextureCoordinate( 0, v, TC1);
            twistStrip.setTextureCoordinate( 0, v+1, TC2);
        }
        return twistStrip;
    }
    ...
    } // end of TexturedLinesApp constructor

    //  The following method allows this to be run as an application

    public static void main(String[] args) {
        System.out.println("TexturedLinesApp - Java 3D API version 1.2");
        ...
        Frame frame = new MainFrame(new TexturedLinesApp(), 256, 256);
    } // end of main method of TexturedLinesApp

} // end of class TexturedLinesApp
