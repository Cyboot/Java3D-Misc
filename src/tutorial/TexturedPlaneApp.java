...
public class TexturedPlaneApp extends Applet {
    ...
    BranchGroup createScene() { 
      ...
      scene.addChild(TG0);
      TG0.addChild(TG1);
      TG1.addChild(new TexturedPlane("ubuntu.png"));

      TG0.addChild(TG2);
      TG2.addChild(new TexturedPlane("ubuntu.png"));

      TG0.addChild(TG3);
      TG3.addChild(TG4);
      TG4.addChild(new TexturedPlane("ubuntu.png"));

      Background background = new Background();
      background.setColor(.0f, 1.0f, .0f);
